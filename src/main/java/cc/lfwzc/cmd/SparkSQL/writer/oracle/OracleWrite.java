...
import cc.lfwzc.cmd.SparkSQL.writer.mysql.MySQLDataType;
...
public class OracleWrite implements SQLWriterInterface {
    private static Logger logger = Logger.getLogger(OracleWrite.class.getName());
    ...
    public OracleWrite(DstConfig dstConfig){
    ...
    public boolean createTable(String tablename, Map<String, String> cols) {
        ...
        try{
            ...
            createBadTableSQL.append(")");
            System.out.println(createBadTableSQL.toString());
